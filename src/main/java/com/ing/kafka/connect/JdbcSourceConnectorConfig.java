...
import com.ing.kafka.connect.jdbc.util.JdbcUtils;
...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  public static final String CDC_ALL_CHANGES = "cdc.allchanges";
  private static final String CDC_ALL_CHANGES_DOC = "Indicator to capture all CDC changes. Allowed values are true or false.";
  private static final String CDC_ALL_CHANGES_DISPLAY = "Capture CDC all changes";
  public static final boolean CDC_ALL_CHANGES_DEFAULT = true;
  
  public static final String CDC_NET_CHANGES = "cdc.netchanges";
  private static final String CDC_NET_CHANGES_DOC = "Indicator to capture net CDC changes. Allowed values are true or false.";
  private static final String CDC_NET_CHANGES_DISPLAY = "Capture CDC net changes";
  public static final boolean CDC_NET_CHANGES_DEFAULT = true;
  ...
  public static ConfigDef baseConfigDef() {
    ...
    addCDCOptions(config);
    return config;
  }
  
  private static final void addCDCOptions(ConfigDef config) {
	  config.define (
			  CDC_ALL_CHANGES,
			  Type.BOOLEAN,
			  CDC_ALL_CHANGES_DEFAULT,
			  Importance.MEDIUM,
			  CDC_ALL_CHANGES_DOC			 
		).define(
			  CDC_NET_CHANGES,
			  Type.BOOLEAN,
			  CDC_NET_CHANGES_DEFAULT,
			  Importance.MEDIUM,
			 CDC_NET_CHANGES_DOC);
  }
  ...
  private static class TableRecommender implements Recommender {
    ...
    public List<Object> validValues(String name, Map<String, Object> config) {
      ...
      String schemaPattern = (String) config.get(MySourceTaskConfig.SCHEMA_PATTERN_CONFIG);
      Set<String> tableTypes = new HashSet<>(
          (List<String>) config.get(MySourceTaskConfig.TABLE_TYPE_CONFIG)
      );
      if (dbUrl == null) {
