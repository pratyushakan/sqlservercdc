...
/**
 * TableQuerier executes queries against a specific table. Implementations
 * handle different types of queries: periodic bulk loading, incremental loads
 * using auto incrementing IDs, incremental loads using timestamps, etc.
 */
